    ...
    function configPublicRoutes($stateProvider) {
        ...
        $stateProvider
            ...
            .state(STATE_PATH+MODULE_NAME+'.pesquisar-convite', {
                ...
                params: {
                    filtro: {
                        filtros: { noObservacao : '', noDespacho: '', tipoEvento: '', idLocalidade : '',remetente:'',descricao:'',flEventoInternacional:'',dtInicioEvento:'',dtFimEvento:'',dataCadInicial:'',dataCadFinal:'',conviteValidacao:''},
                        currentPage: 1,
                        pageSize: 20,
